      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto mt-4">
            (Lorem Ipsum) هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس
            المحتوى) ويستخدم في صناعات الطابع ودور النشر
          </p>
        </div>

        <div className="grid grid-cols-2 gap-8">
          <div className="bg-stone-50 shadow-lg rounded-2xl p-6 flex flex-col items-center text-center">
            <div className="relative mb-16 w-full max-w-md mx-auto">
              <Image
                src={pos}
                alt="حلول نقاط البيع"
                className="rounded-lg"
            ...
            <p className="text-gray-500 mb-6 text-xl">حلول المبيعات</p>
            <div className="flex gap-4 justify-center">
              <a className="border flex items-center justify-center border-primary-20 text-primary-20 font-bold text-xl px-8 py-3 rounded-full hover:bg-green-50 transition">
                اعرف المزيد
              </a>
              <a className="bg-primary-20 text-xl text-white px-8 py-3 rounded-full hover:bg-green-700 transition">
