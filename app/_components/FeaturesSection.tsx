...
export default function FeaturesSection() {
  ...
  return (
    <section className="bg-primary-30 py-16">
      <div className="container mx-auto px-6 text-center text-white">
        <div className="mb-12">
          <h3 className="text-xl font-medium">ميزات حصرية</h3>
          <h2 className="text-4xl font-bold mb-4">
        ...
        <div className="grid grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 text-gray-800">
            ...
            <h4 className="text-2xl font-bold mb-2">
              خيار إصدار الفواتير فوريًا
            </h4>
            <p className="text-gray-600">
              استمتع بإصدار الفواتير بشكل فوري بعد كل عملية بيع. لتبقى على اطلاع
              دائم بكل التفاصيل المالية وتبسيط إدارة مبيعاتك بشكل مباشر وسهل
            </p>
          </div>
