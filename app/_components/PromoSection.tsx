...
const PromoSection: React.FC = () => {
  return (
    <section className="relative flex justify-center items-center bg-slate-300 mt-20 px-20">
      {/* Content Container */}
      <div className="container flex items-center justify-between">
        {/* Text Section */}
        <div className="text-end w-1/2 px-4 py-5">
        ...
        {/* Image Section (Right-Aligned) */}
        <div className="flex justify-end w-1/2 mt-0">
          <div className="relative">
            {/* Single Image for the two phones */}
            <Image src={img} alt="App Preview" className="max-w-full h-auto" />
          </div>
